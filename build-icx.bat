...
icx-cc -std=c23 -pedantic -W -Wall -O3 -flto -fomit-frame-pointer -fuse-ld=lld -DNDEBUG -D_CRT_SECURE_NO_DEPRECATE -march=%1 -fprofile-instr-use=mperft.profdata mperft.c -o .\mperft-3.2-%1.exe
